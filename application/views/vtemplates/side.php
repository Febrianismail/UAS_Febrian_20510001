...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">SMK Bangsa 1 </span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <?php if ($role == 'admin') { ?>
                        <a href="<?= base_url('admin/dashboard') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'dashboard') echo 'active' ?>">
                            <i class="nav-icon fas fa-users"></i>
                            <p>Dashboard</p>
                        </a>
                    <?php } else if($role == 'user') { ?>
                        <a href="<?= base_url('user/dashboard') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'dashboard') echo 'active' ?>">
                            <i class="nav-icon fas fa-users"></i>
                            <p>Dashboard</p>
                        </a>
                    <?php } ?>
                ...
                <li class="nav-item">
                    <a href="<?= base_url('login/logout') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'logout') echo 'active' ?>">
                        <i class="nav-icon "></i>
                        <p>Logout</p>
                    </a>
                </li>
